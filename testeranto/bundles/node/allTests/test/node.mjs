...
var testeranto = async (input2, testSpecification, testImplementation, testInterface, testResourceRequirement = defaultTestResourceRequirement) => {
...
// src/node.ts
var node_default = (testInput, testSpecifications, testImplementations) => Node_default(
  testInput,
  testSpecifications,
  testImplementations,
